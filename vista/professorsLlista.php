...
<head>
  ...
  <script defer src="../js/modals.js"></script></head>
<body>
    ...
    <div class="tituloLista">
      ...
      <div class="date-container">
        ...
        <div class="buttonMenu">
            <button id="addFile"><img class="img" src="../src/copyList.svg" /></button>
        </div>      
    </div>
  </div>
    <div class="textLlista">
      <div class="a">Present</div>
      <div class="b">Falta</div>
      <div class="c">Retard</div>
      <div class="d">Justificat</div>
    </div>
    <div class="semitransparentContLlista">
    <?php include dirname (__FILE__)."/Elements/llistaAl.html"; ?>  
